...
class TrimSliderStyle {
  ...
  const TrimSliderStyle({
    ...
    Color? lineColor,
    Color? onTrimmingColor,
    Color? onTrimmedColor,
    this.lineWidth = 2,
    ...
    this.rightIcon = Icons.arrow_forward_ios_rounded,
            ...
            background ?? (mode == Mode.light ? Colors.white : Colors.black54),
        positionLineColor = positionLineColor ??
            (mode == Mode.light ? Colors.black : Colors.white),
        lineColor =
            lineColor ?? (mode == Mode.light ? Colors.black : Colors.white),
        onTrimmingColor = onTrimmingColor ??
            (mode == Mode.light ? Colors.black : Colors.white),
        onTrimmedColor = onTrimmedColor ??
            (mode == Mode.light ? Colors.black : Colors.white),
        iconColor =
            iconColor ?? (mode == Mode.light ? Colors.white : Colors.black),
        edgesSize =
